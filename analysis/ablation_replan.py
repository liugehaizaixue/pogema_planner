...
# 文件名列表，假设你的文件放在当前目录下
files = ['./result/replan/replan.jsonl','./result/replan/replan_no_greedy_action.jsonl','./result/replan/replan_no_loop_detection.jsonl','./result/replan/replan_no_ld_no_ga.jsonl']  # 添加你的文件名
