...
# 文件名列表，假设你的文件放在当前目录下
files = ['./result/replan.jsonl','./result/epom_norm_best.jsonl','./result/epom_path_se01.jsonl','./result/epom_path_last.jsonl','./result/epom_norm2_best.jsonl','./result/epom_path_best.jsonl']  # 添加你的文件名
algorithm_names = ['Replan','EPOM' ,'EPOM-p-se','EPOM-p-l','EPOM-2b', 'EPOM-p-b']
